function printDCMparams(DCM, data_DCM_path, modelName, SubjName, resting_state)
    ...
    csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vA.csv'); copyfile('hd.csv', csvname);
    dlmwrite(csvname, DCM.Vp.A, '-append', 'delimiter', ',');
    ...
    if ( resting_state == 0 )
        for i = 1:DCM.uN
            ...
            csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vB',i,'.csv'); copyfile('hd.csv', csvname);
            dlmwrite(csvname, DCM.Vp.B(:,:,i)', '-append', 'delimiter', ',');
        end
        ...
        csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vC.csv'); copyfile('hd.csv', csvname);
        dlmwrite(csvname, DCM.Vp.C', '-append', 'delimiter', ',');
    end
    ...
    if ( DCM.options.nonlinear == 1 )
        for i = 1:DCM.n
            ...
            csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vD',i,'.csv'); copyfile('hd.csv', csvname);
            dlmwrite(csvname, DCM.Vp.D(:,:,i)', '-append', 'delimiter', ',');
        end
    end
    ...
    csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vtransit.csv'); copyfile('hd.csv', csvname);
    dlmwrite(csvname, DCM.Vp.transit', '-append', 'delimiter', ',');
    ...
    csvname = strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vdecay.csv'); copyfile('hd.csv', csvname);
    dlmwrite(csvname, DCM.Vp.decay', '-append', 'delimiter', ',');
    ...
    csvwrite( strcat(data_DCM_path,'/results/csv/',modelName,'/',SubjName,'_',modelName,'_vepsilon.csv'), DCM.Vp.epsilon );
